...
import { PacienteProfileService } from '../paciente-profile/paciente-profile.service';
import { MedicoProfileService } from '../medico-profile/medico-profile.service';
...
export class AuthService implements OnModuleInit {
  constructor(
    ...
    private pacienteProfileService: PacienteProfileService,
    private medicoProfileService: MedicoProfileService,
  ) {}
  ...
  async register(registerDto: RegisterDto) {
    ...
    try {
      ...
      case Role.PACIENTE:
        await this.pacienteProfileService.create(userId, {
          nombre: registerDto.nombre,
          telefono: registerDto.telefono,
          fechaNacimiento: registerDto.fechaNacimiento,
          grupoSanguineo: registerDto.grupoSanguineo,
          alergias: registerDto.alergias,
          contactoEmergencia: registerDto.contactoEmergencia,
        });
        break;
      case Role.MEDICO:
        await this.medicoProfileService.create(userId, {
          nombreCompleto: registerDto.nombre,
          telefono: registerDto.telefono,
          especialidad: registerDto.especialidad,
          cmp: registerDto.cmp,
          consultorio: registerDto.consultorio,
        });
        break;
      }
